...
function buyProductPage:render(param)
  print("submit from message page")
  ------------------------------------------------------------------------------
  -- Declarations
  ------------------------------------------------------------------------------
  ...
  authenticationCodeTag:setFillColor( 80 / 255, 80 / 255, 80 / 255 )
  table.insert(properties, authenticationCode)
  table.insert(properties, authenticationCodeTag)

  local confirmAuthenticationCodeBackground = display.newRoundedRect( centerX, centerY + 40, 400, 80, 10)
  confirmAuthenticationCodeBackground:setFillColor(0 / 255, 169 / 255, 126 / 255)
  ...
  confirmAuthenticationCodeFunc = function()
    local function networkListener( event )
      ...
      print ( "RESPONSExzxzxzx: " .. event.response )
    ...
    local tempUrl = { urls.haveAuthenticationCodeForParent, "?user_number=", mobileNumber, urls.serviceCodeProductCode, "&pin=", authenticationCode.text}
