...
if buildingCategories then
  ...
  for i = 1, #coloringCategoriesNames do
    ...
    for file in lfs.dir(doc_path.."/images/"..coloringCategoriesNames[i].name) do
      local check = true
      if file ~= "." and file ~= ".." then
        ...
        local addressPath = system.pathForFile("images/"..coloringCategoriesNames[i].name.."/"..file.."/main.jpg")
        ...
        if not addressPath then
          addressPath = "images/"..coloringCategoriesNames[i].name.."/"..file.."/main.jpg"
        else
          addressPath = "images/"..coloringCategoriesNames[i].name.."/"..file.."/main.png"
        end
        ...
        table.insert(coloringCategories[j], {
          address = "images/"..coloringCategoriesNames[i].name.."/"..file,
