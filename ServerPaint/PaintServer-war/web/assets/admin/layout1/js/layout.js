...
function resetStyle() {
    $('#reset-style').on('click', function(event) {
        ...
        $.removeCookie('boxed-layout');
        $.removeCookie('sidebar-hover');
        $.removeCookie('sidebar-hover', { path: '../../../default.htm'});
        $.removeCookie('main-color', { path: '../../../default.htm'});
        $.removeCookie('main-name', { path: '../../../default.htm'});
        $.removeCookie('theme', { path: '../../../default.htm'});
        $.removeCookie('bg-name', { path: '../../../default.htm'});
        $.removeCookie('bg-color', { path: '../../../default.htm'});
        $.removeCookie('boxed-layout', { path: '../../../default.htm'});
