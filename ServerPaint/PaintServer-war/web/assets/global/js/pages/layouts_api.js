...
function manageLayout(){
    ...
    if($('body').hasClass('fixed-topbar')){
        ...
        $('.topbar-txt').html('current layout: <strong>????bar fixed</strong>');
    } 
    else{
        $('.img-topbar-fluid').removeClass('hidden');
        $('.img-topbar-fixed').addClass('hidden');
        $('.topbar-txt').html('current layout: <strong>????bar fluid</strong>');
    }
    ...
    if($('body').hasClass('boxed')){
        ...
        $('.boxed-txt').html('current layout: <strong>boxed ????</strong>');
    } 
    else{
        $('.layout-boxed .img-boxed').addClass('hidden');
        $('.layout-boxed .img-sidebar-large').removeClass('hidden');
        $('.boxed-txt').html('current layout: <strong>fullwidth ????</strong>');          
    }
