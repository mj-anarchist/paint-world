if ($('.page-content').hasClass('mailbox-send')) {
  ...
  var emailMenuContext = '<div id="context-menu" class="email-context dropdown clearfix">' +
    '<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">' +
    '<li><a href="#" data-label="business" data-color="danger"><i class="fa fa-circle-o c-red" data-label="business" data-color="danger"></i> تجاری</a></li>' +
    '<li><a href="#" data-label="family" data-color="primary"><i class="fa fa-circle-o c-blue" data-label="family" data-color="primary"></i> خانواده </a></li>' +
    '<li><a href="#" data-label="friends" data-color="success"><i class="fa fa-circle-o c-green" data-label="friends" data-color="success"></i> دوستان </a></li>' +
    '<li><a href="#" data-label="personal" data-color="warning"><i class="fa fa-circle-o c-yellow" data-label="personal" data-color="warning"></i> شخصی </a></li>' +
    '<li><a href="#"><i class="fa fa-circle-o c-gray"></i> بدون برچسب</a></li>' +
